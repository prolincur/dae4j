...
public class Source extends Base {
  ...
  public void dump(PrintStream out, int indent) {
    ...
    if (this.floatArray != null) this.floatArray.dump(out, indent + 1);
    if (this.idrefArray != null) this.idrefArray.dump(out, indent + 1);
    if (this.nameArray != null) this.nameArray.dump(out, indent + 1);
    if (this.accessor != null) this.accessor.dump(out, indent + 1);
  }
}
