...
public class sampler2D extends State {
  ...
  public void startElement(String name, Attributes attrs) {
    if (name.equals("source")) setContentNeeded(true);
    else if (name.equals("minfilter")) setContentNeeded(true);
    else if (name.equals("magfilter")) setContentNeeded(true);
    else super.startElement(name, attrs);
  }
