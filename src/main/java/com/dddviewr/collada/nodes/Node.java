...
public class Node extends Base {
  ...
  public void dump(PrintStream out, int indent) {
    ...
    if (this.sid != null) out.print(", sid: " + this.sid);
    ...
    if (this.instanceController != null) this.instanceController.dump(out, indent + 1);
    if (this.instanceNode != null) this.instanceNode.dump(out, indent + 1);
    for (Node n : this.childNodes) n.dump(out, indent + 1);
  }
