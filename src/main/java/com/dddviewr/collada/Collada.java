...
public class Collada extends Base {
  ...
  public void dump(PrintStream out, int indent) {
    ...
    if (this.unit != null) this.unit.dump(out, indent + 1);
    if (this.libraryImages != null) this.libraryImages.dump(out, indent + 1);
    if (this.libraryMaterials != null) this.libraryMaterials.dump(out, indent + 1);
    if (this.libraryEffects != null) this.libraryEffects.dump(out, indent + 1);
    if (this.libraryGeometries != null) this.libraryGeometries.dump(out, indent + 1);
    if (this.libraryNodes != null) this.libraryNodes.dump(out, indent + 1);
    if (this.libraryControllers != null) this.libraryControllers.dump(out, indent + 1);
    if (this.libraryAnimations != null) this.libraryAnimations.dump(out, indent + 1);
    if (this.libraryVisualScenes != null) this.libraryVisualScenes.dump(out, indent + 1);
    if (this.scene != null) this.scene.dump(out, indent + 1);
  }
  ...
  public void deindexMeshes() {
    ...
    for (Geometry geo : geos) {
      ...
      if (mesh != null) mesh.deindex(this);
    }
  }

  public static Collada readFile(String fname)
  ...
  public List<Skin> findSkins(String source) {
    if (this.libraryControllers == null) return new ArrayList<Skin>();
    return this.libraryControllers.findSkins(source);
  }

  public Controller findController(String id) {
    if (this.libraryControllers == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Controller ctrl : this.libraryControllers.getControllers()) {
      if (search.equals(ctrl.getId())) return ctrl;
    }
    return null;
  }

  public Effect findEffect(String id) {
    if (this.libraryEffects == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Effect effect : this.libraryEffects.getEffects()) {
      if (search.equals(effect.getId())) return effect;
    }
    return null;
  }

  public Image findImage(String id) {
    if (this.libraryImages == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Image img : this.libraryImages.getImages()) {
      if (search.equals(img.getId())) return img;
    }
    return null;
  }

  public Material findMaterial(String id) {
    if (this.libraryMaterials == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Material mat : this.libraryMaterials.getMaterials()) {
      if (search.equals(mat.getId())) return mat;
    }
    return null;
  }

  public Geometry findGeometry(String id) {
    if (this.libraryGeometries == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Geometry geo : this.libraryGeometries.getGeometries()) {
      if (search.equals(geo.getId())) return geo;
    }
    return null;
  }

  public Node findNode(String id) {
    if (this.libraryNodes == null) return null;
    String search = id;
    if (id.indexOf(35) == 0) search = id.substring(1);
    for (Node n : this.libraryNodes.getNodes()) {
      if (search.equals(n.getId())) return n;
    }
    return null;
  }
}
